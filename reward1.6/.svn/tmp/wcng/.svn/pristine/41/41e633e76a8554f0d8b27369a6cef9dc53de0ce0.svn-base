...
import com.platform.rp.services.wechat.external.common.alipay.util.httpClient.HttpProtocolHandler;
import com.platform.rp.services.wechat.external.common.alipay.util.httpClient.HttpRequest;
import com.platform.rp.services.wechat.external.common.alipay.util.httpClient.HttpResponse;
import com.platform.rp.services.wechat.external.common.alipay.util.httpClient.HttpResultType;
...
public class AlipaySubmit {
	 ...
	 */
	public static String getRequestURL(String ALIPAY_GATEWAY_NEW,
			Map<String, String> sParaTemp) throws UnsupportedEncodingException {
		// 待请求参数数组
		Map<String, String> sPara = buildRequestPara(sParaTemp);
		List<String> keys = new ArrayList<String>(sPara.keySet());
