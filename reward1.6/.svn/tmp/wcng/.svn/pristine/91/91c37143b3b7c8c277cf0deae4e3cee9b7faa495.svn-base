...
var App = function () {
    ...
    var plugin=function(){
	    ...
	    $.alert=function(title,content){
	    	$("#myDataWindow").modal("hide");
	    	$("#myAlert").find(".myAlertTitle").html(title);
	    	$("#myAlert").find(".myAlertBody").html(content);
	    	
	    	$("#myAlertLink").trigger("click");
	    };
	    
	    $.confirm=function(title,content,_callback,param){
	    	$("#myConfirm").find(".myConfirmTitle").html(title);
	    	$("#myConfirm").find(".myConfirmBody").html(content);
	    	
	    	$("#myConfirmLink").trigger("click");
	    	
	    	$("#myConfirm").find(".ok").unbind('click');
	    	$("#myConfirm").find(".ok").on('click',function(){
	    		$("#myConfirm").modal("hide");
	    		_callback(param);
	    	});
	    };
	    
	    $.dataWindow=function(title,content,_callback,param){
	    	$("#myDataWindow").find(".myDataWindowTitle").html(title);
	    	$("#myDataWindow").find(".myDataWindowBody").html(content);
	    	
	    	$("#myDataWindowLink").trigger("click");
	    	
	    	$("#myDataWindow").find(".saveInfo").unbind('click');	
	    	$("#myDataWindow").find(".saveInfo").on('click',function(){	    		
	    		_callback(param);
	    	});
	    };
    ...
    __CreatePath = function (js) {
        ...
        path = path.substring(0, path.indexOf("/views"));
    ...
    return {
    	path:__CreatePath("bootstrap.min.js"),
        ...
        loading:function(){
			...
			//mask.show();//显示遮罩
			if(document.getElementById('oMask') && document.getElementById('oImg') ){
				...
				oImg.id="oImg";
				oImg.src= "/assets/def/images/load.gif";
