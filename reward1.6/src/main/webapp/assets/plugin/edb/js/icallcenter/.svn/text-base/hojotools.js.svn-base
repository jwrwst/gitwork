...
icallcenter.hojotools.input = function(connectType) {
       ...
       msgObj.innerHTML = "<div style='text-align:right'>" +
       							"<a href=javascript:icallcenter.hojotools.close();>" +
       								"<img src='../../../assets/plugin/edb/imgs/tinybox/close_1.gif' onmouseover=\"this.src='../../../assets/plugin/edb/imgs/tinybox/close_2.gif'\" onmouseout=\"this.src='../../../assets/plugin/edb/imgs/tinybox/close_1.gif'\" />" +
       							"</a>" +
       						"</div>" +
...
icallcenter.hojotools.loading = function(message, parentId) {
	   ...
	   msgObj.innerHTML = "<div style='height:20px;overflow:hidden;text-align:center'><img src='../../../assets/plugin/edb/imgs/loading.gif' style='float:left;margin-top:5px;' /><div id='hollyc5.loading.message' style='float:left;color:#666666;padding-left:5px;'>" + message + "</div><div style='clear:both;height:1px;overflow:hidden'>&nbsp;</div></div>";
...
icallcenter.hojotools.error = function(message) {
    ...
    msgObj.style.lineHeight ="25px";
    msgObj.style.zIndex = "10001";
    msgObj.innerHTML = "<div style='height:27px;background: #f3f3f3;overflow:hidden;padding-top:10px;padding-right:10px;'><div style='float:right'><a href='javascript:icallcenter.hojotools.close();'><img src='../../../assets/plugin/edb/imgs/tinybox/close_1.gif' style='cursor: pointer;border:0px;' /></a></div></div>"+
        					"<div style='height:30px;overflow:hidden;margin-top:20px;padding-left:20px;'><img src='../../../assets/plugin/edb/imgs/error.jpg' style='float:left;margin-top:4px;' /><div style='float:left;color:#666666;padding-left:5px;font-size:15px;padding-top:4px'>"+message+"</div></div>"+
        					"<div style='clear:both;height:1px;overflow:hidden'>&nbsp;</div>"+
        					"<div style='padding-left:180px;padding-top:20px;'><a href='javascript:icallcenter.hojotools.close();'><img src='../../../assets/plugin/edb/imgs/confirm_1.jpg' onmouseover=\"this.src='../../../assets/plugin/edb/imgs/confirm_2.jpg'\" onmouseout=\"this.src='../../../assets/plugin/edb/imgs/confirm_1.jpg'\" style='cursor: pointer;border:0px;' /></a></div>";
...
icallcenter.hojotools.success = function(message) {
	   ...
	   msgObj.innerHTML = "<div style='height:30px;overflow:hidden'><img src='../../../assets/plugin/edb/imgs/success.jpg' style='float:left;margin-top:4px;' /><div style='float:left;color:#666666;padding-left:5px;font-size:15px;padding-top:4px'>" + message + "</div><div class='clear1'>&nbsp;</div></div>";
