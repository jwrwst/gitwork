DateInput = (function($) {
	...
	DateInput.prototype = {
		build: function() {
			var monthNav = $('<p class="month_nav">' + '<span class="button prev" title="[Page-Up]">&#171;</span>' + ' <span class="month_name" style="float:none;"></span> ' + '<span class="button next" title="[Page-Down]">&#187;</span>' + '</p>');
			...
			var yearNav = $('<p class="year_nav">' + '<span class="button prev" title="[Ctrl+Page-Up]">&#171;</span>' + ' <span class="year_name" style="float:none;"></span> ' + '<span class="button next" title="[Ctrl+Page-Down]">&#187;</span>' + '</p>');
