 ...
 *
 */
@Path("/external/employeeExtReward")
@Produces(MediaType.APPLICATION_JSON)
public interface IExBsEmployeeExtRewardRest {
...
//	@POST
//    @Path("/getEmployeeRewardRankByStoreID")
//	//根据店铺ID获取店员评价排名
//	public RestfulResult getEmployeeRewardRankByStoreID(@QueryParam("storeId") long storeID, @QueryParam("filter") String filter);
